            ...
            <div className="flex flex-col flex-start gap-2 bg-white pb-2 my-4 border rounded-lg">
                <div className='flex justify-between items-start gap-1 px-2 py-2 w-full mb-2'>
                    ...
                    <div className='flex justify-center gap-x-2'>
                        <a href='#'>
                        <img src={userImag} className="w-10 h-10 rounded-full"/>
                        </a>
                ...
                <div className="post-content">
                    <article>
                        ...
                        <div className='w-full'>
                            <img src={domingo} alt="domingo" className='w-full' />
                        </div>
                    </article>
                    ...
                    <div className="comment px-4 py-2">
                        ...
                        <div className="flex justify-center items-center border-y py-2 mt-2">
                            ...
                            {/* <div className="flex justify-self-end">
                               <img src="https://placeimg.com/80/80/people" className="w-6 h-6 rounded-full"/>
                            </div> */}
                        </div>
